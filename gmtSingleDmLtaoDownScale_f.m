...
forceSettings = false;
filename  = '../mat_data/gmtSingleDmLtaoDownScaleSettings.mat';
...
% sumGmtPups = sum(gmtPups)';
    ...
    ngs = ngs.*tel;
    dmWfsCalib = calibration(dm,wfs,ngs,ngs.wavelength);
...
loopGain = 0.5;
nIteration = 500;
srcorma = sourceorama('../mat_data/gmtSingleDmLtaoDownScale1.h5',[ngs;lgs(:)],nIteration*tel.samplingTime,tel,0.25);
%%
% closing the loop
